...
SECRET_KEY = 'django-insecure-32g3#65*%6!(sdg%@kw285y%!a$694sjp_^8bi+r!fyh$2*je('
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') # Replace with your desired directory
MEDIA_URL = '/media/'


# MODEL_PATH = os.path.join(BASE_DIR, 'voting_classifier_model.pkl')
